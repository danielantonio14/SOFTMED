...
$query = $BD->query("SELECT *FROM casos
  ...
  WHERE casos.id_localidade = '$l' AND casos.dia = '$d' AND casos.mes = '$m' AND casos.ano = '$a'
...
if ($contar > 0) {
  ...
  <body class="fundo">
    ...
    <h1>SOFTMED</h1>
    <h2>RELATÓRIO DE TODOS OS CASOS ESTUDADOS A NÍVEL DE ' . strtoupper($municipio) . ' <br> <b>total de registros(' . $contar . ')</b> </h2>
    <div class="flex">
